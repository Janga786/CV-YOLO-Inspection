...
class FlickrImageFinder:
    ...
    def search_flickr_images(self, query, num_images=10):
        ...
        while len(urls) < num_images:
            ...
            try:
                ...
                print(f"Found {len(style_tags)} style tags on page {page}.")
                if not style_tags:
                    print("No more style tags found. Stopping search.")
                    break
    ...
    def run(self, target_per_category=5):
        print("=== Starting Flickr Image Finder (Debug Mode) ===")
        ...
        print("\n=== Flickr Image Finder (Debug Mode) Finished ===")
