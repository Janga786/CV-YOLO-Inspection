...
class FlickrImageFinder:
            ...
            try:
                ...
                for img in img_tags:
                    if 'src' in img.attrs and 'staticflickr.com' in img['src']:
                        ...
                        if url.startswith("//"):
                            url = "https" + url
                        # The URLs are often for thumbnails, we try to get the full size image by replacing _m.jpg with _b.jpg
    ...
    def run(self, target_per_category=20):
        print("=== Starting Flickr Image Finder V3 ===")
        ...
        print("\n=== Flickr Image Finder V3 Finished ===")
